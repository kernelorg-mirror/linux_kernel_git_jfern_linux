...
impl RadixFirmware {
    pub(crate) fn new(
        ...
        // TODO: discrepency between capacity and size after this call... That's because the size
        // of lvl2 is not a multiple of 4096, so we are skipping the last page apparently?
        ...
        pr_info!(
            ...
            u64::from_le_bytes(unsafe { *(lvl0.start_ptr() as *const [u8; 8]) })
        );
        pr_info!(
