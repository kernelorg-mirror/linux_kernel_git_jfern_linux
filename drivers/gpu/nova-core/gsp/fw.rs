...
impl GspMsgElement {
    ...
    pub(crate) fn payload_length(&self) -> usize {
        ...
        num::u32_as_usize(self.rpc.length).saturating_sub(size_of::<r000::rpc_message_header_v>())
    }
...
impl MessageQueueInitArguments {
    ...
    fn new(cmdq: &Cmdq) -> Self {
        Self(r000::MESSAGE_QUEUE_INIT_ARGUMENTS {
            ...
            queueElementHdrSize: core::mem::offset_of!(r000::GSP_MSG_QUEUE_ELEMENT, payload) as u64,
