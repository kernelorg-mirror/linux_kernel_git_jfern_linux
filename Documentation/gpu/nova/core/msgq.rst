...
An RPC message itself has multiple headers. There is a "message queue" header
which handles message queue specific details and integrity, followed by a "RPC" header
which handles the RPC protocol details::
